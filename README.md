...
| Provider | Notes |
|----------|-------|
| **Google Gemini** | Default, Gemini 3.x family (3.8 Flash, 3.8 Flash-Lite, 3.8 Pro, 3.7 Flash, 3.6 Flash, 3.5 Flash-Lite, 3.1 Flash Lite), free tier available, key rotation supported |
| OpenAI | GPT models |
...
| Channel | Link |
|---------|------|
| **Issues & Bugs** | [Open an issue](https://github.com/0xbajt/StremioSubMaker/issues) |
